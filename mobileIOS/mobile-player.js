// mobile-player.js - Gestione player video (VERSIONE ORIGINALE CON VIDEO.JS)
        ...
        mobilePlayer.ready(() => {
            ...
            if (playPromise !== undefined) {
                playPromise.catch(error => {
                    ...
                    // showMobileInfo('Tocca il video per avviare la riproduzione'); // COMMENTATO perché showMobileInfo non esiste
                });
            }
        });

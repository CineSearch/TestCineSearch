...
async function getStreamData(isMovie, id, season = null, episode = null, useProxy = true) {
  try {
    ...
    // Estrai i parametri della playlist
    ...
    // Controlla se può riprodurre FHD
    ...
    showLoading(false);
    console.error("Errore getStreamData:", error);
